...
<div id="editarProveedor" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="editarProveedorForm" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" style="padding: 20px;">
               <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="form-group">
                     <div class="col-md-12" style="padding-top: 15px;">
                        <button {{-- type="submit" --}} onclick="ValidarGeneral('editarProveedorForm', 'update', 'proveedores')" style="width: 100%" class="btn btn-success btn-modal btn_avicola">Guardar</button>
                        <div align="center">
...
<script>
	$(document).ready(function(){
      $("#editarProveedorForm #pais, #editarProveedorForm #provincia, #editarProveedorForm #departamento, #editarProveedorForm #distrito, #editarProveedorForm #tipo_persona, #editarProveedorForm #tipo_documento").chosen();
      validateUbigeoEditarProvee("editarProveedorForm");
      validateTipoDocumentoEditarProvee();
   });
      ...
      $("#editarProveedorForm #distrito").empty();
         ...
         $("#editarProveedorForm #distrito").append("<option>"+"AMAZONAS"+"</option>");
