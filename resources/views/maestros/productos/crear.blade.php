         ...
         <div class="modal-body">
            <form id="crearProductoForm" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" style="padding: 20px;">
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <small class='form_description'>Tipo Producto</small>
                           <select onchange="JabaPeso()" id="id_tipo_producto" required="required" class="form-control col-md-7 col-xs-12">
...
{{--                    <div class="col-md-6">
                     <div class="form-group">
                        <small class='form_description'>Proveedordel Producto</small>
...
<script>
   function JabaPeso() {
      if ($("#id_tipo_producto").val()==="3") {
         $("#id_tipo_producto").parent().parent().append('<div style="display:none; padding:0px;" class="col-md-12">'+
                                                                     '<div class="form-group">'+
                                                                              '<small class="form_description">Peso de la jaba</small>'+
                                                                              '<input type="text" id="peso" required="required" class="form-control col-md-7 col-xs-12">'+
                                                                     '</div>'+
                                                                  '</div>');
         $("#peso").parent().parent().show(300);
      }
      else{
         $("#peso").parent().parent().hide(300, function(){
            $(this).remove()
         });
      }
   }
