                              ...
                              <div class="checkbox">
                                  <label class="" onclick="ProductCountEdit('producto_{{$Producto->id}}')">
                                    <div class="icheckbox_flat-green" style="position: relative;">
                                       <input type="checkbox" class="flat" name="producto_{{$Producto->id}}" id="producto_{{$Producto->id}}" data-estatus="{{$Producto->estatus}}" data-id_guia_entrada="{{$Producto->id_guia_entrada}}" value="{{$Producto->id}}" style="position: absolute; opacity: 0;">
...
<script>
   ...
   $(document).ready(function(){
      ...
      $("#editarGuiaEntrada #product_numer").text(window.ProductNumber);
   })
   ...
   function ProductCountbtnEdit(){
      ...
      $("#editarGuiaEntrada #product_numer").text(Produc);
