...
class ContactosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("maestros.contactos.contactos", ["TipoPersonas" => $TipoPersona, "TipoDocumentos" => $TipoDocumento, "Paises" => $Paises, "Ubigeo" => $Ubigeo,"no_permitidas" => $no_permitidas, "permitidas" => $permitidas, "Clientes" => $Clientes, "Proveedores" => $Proveedores, "Contactos" => $Contactos]);
    }
