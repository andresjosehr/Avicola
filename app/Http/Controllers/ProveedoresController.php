...
class ProveedoresController extends Controller
{
    ...
    public function index()
    {
        ...
        $Proveedores=Proveedores::with("Ubigeo")->get();
    ...
    public function store(Request $request)
    {
        ...
        Proveedores::create($request->except("departamento", "provincia", "distrito"));
        return "Exito";
    }
     ...
     public function listUpdate()
    {
        ...
        return view("maestros.proveedores.lista", ["TipoPersonas" => $TipoPersona, "TipoDocumentos" => $TipoDocumento, "Paises" => $Paises, "Ubigeo" => $Ubigeo,"no_permitidas" => $no_permitidas, "permitidas" => $permitidas, "Proveedores" => $Proveedores]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Proveedores::where("id", $id)->update($request->except("departamento", "provincia", "distrito", "_method"));
        return "Exito";
    }
